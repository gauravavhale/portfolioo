    ...
    <div className="container d-flex flex-column align-items-center justify-content-center">
      ...
      <div className="landing row w-100 justify-content-center pt-5 pb-5">
        ...
        <div className="titleCard col-12 col-md-6">
          <div
            className="card shadow cardCover border-0"
        ...
        <div className="col-12 col-md-6 desc text-white">
          ...
          <div className="col-12 col-md-6 d-flex align-items-center gap-4 socials mt-2">
            <span
              onClick={() =>
                (window.location.href =
                  "https://www.linkedin.com/in/gaurav-avhale-631690313/")
              }
            ...
            <span
              onClick={() =>
                (window.location.href =
                  "https://www.instagram.com/gaurav.avhale_18?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==")
              }
      ...
      <div className="about row justify-content-center">
        ...
        <div className="col-12 col-md-6 text-white p-3">
          ...
          <p className="text-center" style={{ fontSize: "0.95rem", lineHeight: "1.6" }}>
            ...
            <strong>React</strong>, <strong>Next.js</strong>, <strong>JavaScript</strong>,
            and <strong>CSS</strong> to build modern, intuitive interfaces.
            <br />
            <br />
            My journey began with a simple curiosity for how websites work — and has
            grown into a deep passion for creating dynamic, accessible, and beautiful
          ...
          <div key={i} className="col-12 col-md-4 mb-4">
            ...
            >
              ...
              <div className="card-body px-0">
                <h4 className="card-title mb-2" style={{ color: "#ffc107" }}>
                  {project.title}
                </h4>
        ...
        <div>
          ...
          >
            ...
            <p style={{ maxWidth: "700px", lineHeight: "1.6" }}>
              🚀 Let's build something <strong>impactful</strong> together! Whether
              you’ve got a project idea, a job opportunity, or just want to say hello —
              I’d love to hear from you.
              <br />
              <br />
              I'm always open to <strong>creative collaborations</strong>,{" "}
              <strong>freelance gigs</strong>, or just a quick tech chat ☕.
              <br />
              If you believe we can create something meaningful together, don’t hesitate
              to reach out.
              <br />
              <br />
              I usually respond within a day. Let’s connect and make something awesome
              happen!
            </p>
          ...
          <div className="row">
            <div className="col-12 col-md-6 d-flex justify-content-center align-items-center gap-4 mt-4">
              <span
                ...
                className="bi bi-linkedin socialIcon"
              ></span>
              <span
                onClick={() =>
                  (window.location.href =
                ...
                className="bi bi-instagram socialIcon"
              ></span>
              <span
                onClick={() => (window.location.href = "mailto:avhalegaurav07@gmail.com")}
                className="bi bi-envelope socialIcon"
              ></span>
              <span
                onClick={() => (window.location.href = "tel:8698873705")}
                className="bi bi-phone socialIcon"
              ></span>
            </div>
